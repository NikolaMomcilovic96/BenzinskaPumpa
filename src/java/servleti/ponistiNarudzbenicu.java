...
public class ponistiNarudzbenicu extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String upit = "DELETE FROM narudzbenica WHERE idNarudzbenice = '" + Sifra + "'";
            ...
            request.setAttribute("poruka", "Uspešno ste poništili narudžbenicu");
            request.getRequestDispatcher("index.jsp").forward(request, response);
